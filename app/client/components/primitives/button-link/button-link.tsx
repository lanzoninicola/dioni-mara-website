...
export function ButtonLink({ label, to }: ButtonLinkProps) {
    return (
        <a
            href={to}
...
export function ButtonLinkSpotted({ label, to }: ButtonLinkProps) {
    return (
        <a
            href={to}
        ...
        >
            <span className="text-md text-white uppercase tracking-wider">{label}</span>
        </a>
    );
}
